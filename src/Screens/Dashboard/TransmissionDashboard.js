...
import {
  getIncomes,
  getIncomeTransmissionLogs,
  getTrasmissionDashboardData
...
class TransmissionDashboard extends React.Component {
  constructor() {
    super()
    this.state = {
      transmittedCurrency: '',
  ...
  getLogs = (time) => {
    setTimeout(() => {
      getIncomeTransmissionLogs().then((logs) => {
        if (logs) {
          this.setState({ logs })
        }
      })
          ...
          <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 24 }} lg={{ span: 8 }}>
            <div className="overview card">
              ...
              <Row gutter={(16, 20)}>
                ...
                <Link to="/app/outbound-transmissions">View Transmissions</Link>
              </Row>
            </div>
          </Col>
          ...
          <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 24 }} lg={{ span: 8 }}>
            <div className="overview card">
              ...
              <Row gutter={(16, 20)}>
                ...
                <Link to="/app/outbound-transmissions">View Pending Transmissions</Link>
              </Row>
            </div>
          </Col>
