...
export default function Position() {
  ...
  const positionJSON = {
    ...
    page: 'POSITIONS',
    endpoint: 'positions',
    setFilter: 'positions.filterData',
    table: {
      header: [
        {
          flex: 0.15,
    ...
    export: {
      header: ['Valid From', 'Valid To', 'Position Id', 'Position Title', 'Org Unit'],
      data: ['validFrom', 'validTo', 'positionId', 'positionTitle', 'orgUnit'],
  ...
  const emitData = (param: any) => {
    switch (param.TYPE) {
      case 'NEW':
        return history('/app/add-position')
      default:
        console.log('test')
        break
    }
  ...
  return (
    <Grid container spacing={6} sx={{ height: '100%', padding: 2 }}>
      <Grid item xs={12} sx={{ pb: 5 }}>
        <TableBox tableConfig={positionJSON} emitData={emitData} />
      </Grid>
    </Grid>
  )
}
