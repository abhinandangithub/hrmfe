...
export default function EmployeeGroup() {
  ...
  function tableAction(param: any) {
    if (param.TYPE === 'EDIT') {
      history(`/app/employee-groups/${param.id}`)
    }
  }

  const employeeGroupJson = {
    title: 'Employee Group Overview',
    page: 'EMPLOYEEGROUP',
    endpoint: 'employee-groups',
    setFilter: 'employeeGroups.filterData',
    table: {
      header: [
        {
          flex: 0.25,
        ...
        },
        {
          ...
          headerName: t('Employee Group Text'),
          headerClassName: 'super-app-theme--header',
    ...
    export: {
      header: ['Valid From', 'Valid To', 'Employee Group Id', 'Employee Group Text'],
      data: ['validFrom', 'validTo', 'employeeGroupId', 'employeeGroupText'],
      btnTitle: 'Add Employee Group'
    },
    filters: null
  }
  ...
  const emitData = (param: any) => {
    switch (param.TYPE) {
      case 'NEW':
        return history('/app/add-employee-group')
      default:
        console.log('test')
        break
    }
  ...
  return (
    <Grid container spacing={6} sx={{ height: '100%', padding: 2 }}>
      <Grid item xs={12} sx={{ pb: 5 }}>
        <TableBox tableConfig={employeeGroupJson} emitData={emitData} />
      </Grid>
    </Grid>
  )
}
