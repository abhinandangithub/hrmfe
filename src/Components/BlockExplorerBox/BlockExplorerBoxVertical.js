...
class BlockExplorerBoxVertical extends React.PureComponent {
  render() {
    if (this.props.visible) {
      return this.props.layout ? (
        <div className="blockchain-explorer-holder vertical-view">
...
export default BlockExplorerBoxVertical
